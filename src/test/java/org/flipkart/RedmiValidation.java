...
public class RedmiValidation {
	...
	public void Script5() throws Exception {
		...
		File Target = new File("C:\\Users\\HP\\eclipse-workspace\\SteveFramework\\Screenshot\\Flipkart.png");
	...
	@Test
	public void Script6() {
		WebElement validatename = driver.findElement(By.xpath("(//span[contains(text(),'REDMI')])[1]"));
